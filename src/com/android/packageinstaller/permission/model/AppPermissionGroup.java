...
public final class AppPermissionGroup implements Comparable<AppPermissionGroup> {
    ...
    public boolean grantRuntimePermissions(boolean fixedByTheUser) {
        ...
        if (Utils.SU_GROUP.equals(mName)) {
            ...
            mAppOps.setMode(permission.getAppOp(), mPackageInfo.applicationInfo.uid, mPackageInfo.packageName, AppOpsManager.MODE_ALLOWED);
            final boolean appOpAllowed = (mAppOps.checkOp(permission.getAppOp(),
    ...
    public boolean revokeRuntimePermissions(boolean fixedByTheUser) {
        ...
        if (Utils.SU_GROUP.equals(mName)) {
            ...
            mAppOps.setMode(permission.getAppOp(), mPackageInfo.applicationInfo.uid, mPackageInfo.packageName, AppOpsManager.MODE_IGNORED);            
            final boolean appOpAllowed = (mAppOps.checkOp(permission.getAppOp(),
                        mPackageInfo.applicationInfo.uid, mPackageInfo.packageName) == AppOpsManager.MODE_ALLOWED);
            permission.setAppOpAllowed(appOpAllowed);
            permission.setGranted(appOpAllowed);
